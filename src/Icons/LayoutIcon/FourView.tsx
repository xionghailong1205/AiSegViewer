...
const FourView = (props: SvgProp) => (
    ...
    >
        ...
        <path
            stroke="white"
            d="M25 1.556H3c-.53 0-1.04.327-1.414.91C1.21 3.05 1 3.843 1 4.667V14h26V4.667c0-.825-.21-1.617-.586-2.2-.375-.584-.884-.911-1.414-.911Z"
            clipRule="evenodd"
        />
    </svg>
)
