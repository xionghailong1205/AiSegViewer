var ICRPolySegApp = (() => {
  ...
  return function (ICRPolySegApp) {
    ICRPolySegApp = ICRPolySegApp || {};

    var Module = typeof ICRPolySegApp != "undefined" ? ICRPolySegApp : {};
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "ICRPolySeg.wasm";
    if (!isDataURI(wasmBinaryFile)) {
      console.log(JSON.stringify(wasmBinaryFile));
    ...
    var _main = (Module["_main"] = function () {
      return (_main = Module["_main"] = Module["asm"]["S"]).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_viij = (Module["dynCall_viij"] = function () {
      return (dynCall_viij = Module["dynCall_viij"] = Module["asm"]["Z"]).apply(
        null,
        arguments
      );
    });
    var dynCall_vij = (Module["dynCall_vij"] = function () {
      return (dynCall_vij = Module["dynCall_vij"] = Module["asm"]["_"]).apply(
        null,
        arguments
      );
    });
    var dynCall_iij = (Module["dynCall_iij"] = function () {
      return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["$"]).apply(
        null,
        arguments
      );
    });
    ...
    var ___start_em_js = (Module["___start_em_js"] = 638316);
    var ___stop_em_js = (Module["___stop_em_js"] = 638383);
    var calledRun;
